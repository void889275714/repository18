...
public class EntityGenerator {
    ...
    public void entityGenerator() {
        ...
        gc.setOutputDir("D:\\JAVA\\WorkSpace\\projectGuns\\meeting-theater\\guns\\guns-film\\src\\main\\java");//这里写你自己的java目录
        ...
        strategy.setInclude(new String[]{"user","mtime_banner_t", "mtime_film_t","mtime_film_info_t","mtime_hall_film_info_t",
                "mtime_cat_dict_t","mtime_year_dict_t","mtime_source_dict_t","mtime_actor_t",
                "mtime_film_actor_t"});
