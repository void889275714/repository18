...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // 测试当面付2.0生成支付二维码
        String s = main.getPayQRCode("87sdf74512378er123", "aaa", "88", "bbb");
    ...
    public String queryPayResult(String orderId) {
        AlipayClient alipayClient = new DefaultAlipayClient("https://openapi.alipay.com/gateway.do","2016102100732230","your private_key","json","GBK","alipay_public_key","RSA2");
